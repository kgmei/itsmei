...
public class threetablesleftjoin {
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            String sql = "SELECT * " +
                         ...
                         "LEFT JOIN employeedetails t2 ON t1.desigid = t2.desigid " +
                         "LEFT JOIN qualificationtable t3 ON t2.qualificationid = t3.qualificationid";
